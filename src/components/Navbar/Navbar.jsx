...
const Navbar = () => {
  return <nav className={s.nav}>
    <div className={s.item}>
      <NavLink exact to="/profile" className={(navData) => navData.isActive ? s.active : "" }>Profile</NavLink>
    </div>
    <div className={s.item}>
    ...
    <div className={s.item}>
      <NavLink to="/dialogs"  className={(navData) => navData.isActive ? s.active : "" }>Massages</NavLink>
    </div>
    <div className={s.item}>
